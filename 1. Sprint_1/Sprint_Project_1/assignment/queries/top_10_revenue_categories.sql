...
FROM olist_products
    LEFT JOIN olist_order_items ON olist_products.product_id = olist_order_items.product_id
    ...
    LEFT JOIN product_category_name_translation ON olist_products.product_category_name = product_category_name_translation.product_category_name
